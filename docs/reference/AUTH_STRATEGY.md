...
| Provider | Auth URL | Client ID | Callback Port | PKCE |
|----------|----------|-----------|---------------|------|
| OpenAI | auth.openai.com/authorize | app-brainstew | 1455 | Yes |
| Google | accounts.google.com/o/oauth2/v2/auth | (requires setup) | 1456 | Yes |
| xAI | N/A | N/A | N/A | N/A |
